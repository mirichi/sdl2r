...
// enum
VALUE sdl2r_enum_HatPositionsEnum;
VALUE sdl2r_enum_ButtonStateEnum;
VALUE sdl2r_enum_EventTypeEnum;
VALUE sdl2r_enum_WindowEventIDEnum;
...
{
    // SDL module methods
    SDL2R_DEFINE_SINGLETON_METHOD(poll_event, 0);
    SDL2R_DEFINE_SINGLETON_METHOD(push_event, 1);
    SDL2R_DEFINE_SINGLETON_METHOD(register_events, 1);
    SDL2R_DEFINE_SINGLETON_METHOD(event_state, 2);

//    SDL2R_DEFINE_SINGLETON_METHOD(add_event_watch, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(del_event_watch, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(filter_events, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(flush_event, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(flush_events, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(get_event_filter, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(get_num_touch_devices, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(get_num_touch_fingers, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(get_touch_device, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(get_touch_finger, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(has_event, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(has_events, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(load_dollar_templates, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(peep_events, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(pump_events, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(quit_requested, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(record_gesture, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(save_all_dollar_templates, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(save_dollar_template, 0);
//    SDL2R_DEFINE_SINGLETON_METHOD(set_event_filter, 0);
    SDL2R_DEFINE_SINGLETON_METHOD(wait_event, 1);
//    SDL2R_DEFINE_SINGLETON_METHOD(wait_event_timeout, 0);

    SDL2R_DEFINE_SINGLETON_METHOD(add_timer_event, 2);
    SDL2R_DEFINE_SINGLETON_METHOD(remove_timer_event, 1);

    // SDL macro
    SDL2R_DEFINE_SINGLETON_METHOD(BUTTON, 1);
    ...
    // define enum
    SDL2R_DEFINE_ENUM(HatPositionsEnum);
    SDL2R_DEFINE_ENUM_VALUE(HatPositionsEnum, HAT_CENTERED);
    SDL2R_DEFINE_ENUM_VALUE(HatPositionsEnum, HAT_UP);
    SDL2R_DEFINE_ENUM_VALUE(HatPositionsEnum, HAT_RIGHT);
    SDL2R_DEFINE_ENUM_VALUE(HatPositionsEnum, HAT_DOWN);
    SDL2R_DEFINE_ENUM_VALUE(HatPositionsEnum, HAT_LEFT);
    SDL2R_DEFINE_ENUM_VALUE(HatPositionsEnum, HAT_RIGHTUP);
    SDL2R_DEFINE_ENUM_VALUE(HatPositionsEnum, HAT_RIGHTDOWN);
    SDL2R_DEFINE_ENUM_VALUE(HatPositionsEnum, HAT_LEFTUP);
    SDL2R_DEFINE_ENUM_VALUE(HatPositionsEnum, HAT_LEFTDOWN);

    SDL2R_DEFINE_ENUM(ButtonStateEnum);
    SDL2R_DEFINE_ENUM_VALUE(ButtonStateEnum, PRESSED);
    SDL2R_DEFINE_ENUM_VALUE(ButtonStateEnum, RELEASED);

    SDL2R_DEFINE_ENUM(EventTypeEnum);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, FIRSTEVENT);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, QUIT);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, APP_TERMINATING);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, APP_LOWMEMORY);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, APP_WILLENTERBACKGROUND);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, APP_DIDENTERBACKGROUND);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, APP_WILLENTERFOREGROUND);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, APP_DIDENTERFOREGROUND);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, WINDOWEVENT);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, SYSWMEVENT);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, KEYDOWN);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, KEYUP);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, TEXTEDITING);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, TEXTINPUT);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, MOUSEMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, MOUSEBUTTONDOWN);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, MOUSEBUTTONUP);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, MOUSEWHEEL);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, JOYAXISMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, JOYBALLMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, JOYHATMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, JOYBUTTONDOWN);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, JOYBUTTONUP);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, JOYDEVICEADDED);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, JOYDEVICEREMOVED);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, CONTROLLERAXISMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, CONTROLLERBUTTONDOWN);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, CONTROLLERBUTTONUP);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, CONTROLLERDEVICEADDED);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, CONTROLLERDEVICEREMOVED);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, CONTROLLERDEVICEREMAPPED);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, FINGERDOWN);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, FINGERUP);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, FINGERMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, DOLLARGESTURE);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, DOLLARRECORD);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, MULTIGESTURE);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, CLIPBOARDUPDATE);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, DROPFILE);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, RENDER_TARGETS_RESET);
//    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, SDL_RENDER_DEVICE_RESET);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, USEREVENT);
    SDL2R_DEFINE_ENUM_VALUE(EventTypeEnum, LASTEVENT);

    SDL2R_DEFINE_ENUM(WindowEventIDEnum);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventIDEnum, WINDOWEVENT_NONE);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventIDEnum, WINDOWEVENT_SHOWN);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventIDEnum, WINDOWEVENT_HIDDEN);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventIDEnum, WINDOWEVENT_EXPOSED);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventIDEnum, WINDOWEVENT_MOVED);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventIDEnum, WINDOWEVENT_RESIZED);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventIDEnum, WINDOWEVENT_SIZE_CHANGED);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventIDEnum, WINDOWEVENT_MINIMIZED);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventIDEnum, WINDOWEVENT_MAXIMIZED);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventIDEnum, WINDOWEVENT_RESTORED);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventIDEnum, WINDOWEVENT_ENTER);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventIDEnum, WINDOWEVENT_LEAVE);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventIDEnum, WINDOWEVENT_FOCUS_GAINED);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventIDEnum, WINDOWEVENT_FOCUS_LOST);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventIDEnum, WINDOWEVENT_CLOSE);

    // Constants
    SDL2R_DEFINE_CONST(BUTTON_LEFT);
    SDL2R_DEFINE_CONST(BUTTON_MIDDLE);
    SDL2R_DEFINE_CONST(BUTTON_RIGHT);
    SDL2R_DEFINE_CONST(BUTTON_X1);
    SDL2R_DEFINE_CONST(BUTTON_X2);
    SDL2R_DEFINE_CONST(BUTTON_LMASK);
    SDL2R_DEFINE_CONST(BUTTON_MMASK);
    SDL2R_DEFINE_CONST(BUTTON_RMASK);
    SDL2R_DEFINE_CONST(BUTTON_X1MASK);
    SDL2R_DEFINE_CONST(BUTTON_X2MASK);
}
