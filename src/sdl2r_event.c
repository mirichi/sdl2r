...
VALUE sdl2r_EnumButtonState;
VALUE sdl2r_EnumEventType;
VALUE sdl2r_EnumWindowEventID;
...
//    SDL2R_DEFINE_SINGLETON_METHOD(wait_event_timeout, 0);
    ...
    SDL2R_DEFINE_ENUM_VALUE(EnumHatPositions, HAT_CENTERED);
    SDL2R_DEFINE_ENUM_VALUE(EnumHatPositions, HAT_UP);
    SDL2R_DEFINE_ENUM_VALUE(EnumHatPositions, HAT_RIGHT);
    SDL2R_DEFINE_ENUM_VALUE(EnumHatPositions, HAT_DOWN);
    SDL2R_DEFINE_ENUM_VALUE(EnumHatPositions, HAT_LEFT);
    SDL2R_DEFINE_ENUM_VALUE(EnumHatPositions, HAT_RIGHTUP);
    SDL2R_DEFINE_ENUM_VALUE(EnumHatPositions, HAT_RIGHTDOWN);
    SDL2R_DEFINE_ENUM_VALUE(EnumHatPositions, HAT_LEFTUP);
    SDL2R_DEFINE_ENUM_VALUE(EnumHatPositions, HAT_LEFTDOWN);

    SDL2R_DEFINE_ENUM(EnumButtonState);
    SDL2R_DEFINE_ENUM_VALUE(EnumButtonState, PRESSED);
    SDL2R_DEFINE_ENUM_VALUE(EnumButtonState, RELEASED);

    SDL2R_DEFINE_ENUM(EnumEventType);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, FIRSTEVENT);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, QUIT);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, APP_TERMINATING);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, APP_LOWMEMORY);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, APP_WILLENTERBACKGROUND);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, APP_DIDENTERBACKGROUND);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, APP_WILLENTERFOREGROUND);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, APP_DIDENTERFOREGROUND);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, WINDOWEVENT);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, SYSWMEVENT);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, KEYDOWN);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, KEYUP);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, TEXTEDITING);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, TEXTINPUT);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, MOUSEMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, MOUSEBUTTONDOWN);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, MOUSEBUTTONUP);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, MOUSEWHEEL);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, JOYAXISMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, JOYBALLMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, JOYHATMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, JOYBUTTONDOWN);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, JOYBUTTONUP);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, JOYDEVICEADDED);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, JOYDEVICEREMOVED);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, CONTROLLERAXISMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, CONTROLLERBUTTONDOWN);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, CONTROLLERBUTTONUP);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, CONTROLLERDEVICEADDED);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, CONTROLLERDEVICEREMOVED);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, CONTROLLERDEVICEREMAPPED);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, FINGERDOWN);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, FINGERUP);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, FINGERMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, DOLLARGESTURE);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, DOLLARRECORD);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, MULTIGESTURE);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, CLIPBOARDUPDATE);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, DROPFILE);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, RENDER_TARGETS_RESET);
//    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, SDL_RENDER_DEVICE_RESET);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, USEREVENT);
    SDL2R_DEFINE_ENUM_VALUE(EnumEventType, LASTEVENT);

    SDL2R_DEFINE_ENUM(EnumWindowEventID);
    SDL2R_DEFINE_ENUM_VALUE(EnumWindowEventID, WINDOWEVENT_NONE);
    SDL2R_DEFINE_ENUM_VALUE(EnumWindowEventID, WINDOWEVENT_SHOWN);
    SDL2R_DEFINE_ENUM_VALUE(EnumWindowEventID, WINDOWEVENT_HIDDEN);
    SDL2R_DEFINE_ENUM_VALUE(EnumWindowEventID, WINDOWEVENT_EXPOSED);
    SDL2R_DEFINE_ENUM_VALUE(EnumWindowEventID, WINDOWEVENT_MOVED);
    SDL2R_DEFINE_ENUM_VALUE(EnumWindowEventID, WINDOWEVENT_RESIZED);
    SDL2R_DEFINE_ENUM_VALUE(EnumWindowEventID, WINDOWEVENT_SIZE_CHANGED);
    SDL2R_DEFINE_ENUM_VALUE(EnumWindowEventID, WINDOWEVENT_MINIMIZED);
    SDL2R_DEFINE_ENUM_VALUE(EnumWindowEventID, WINDOWEVENT_MAXIMIZED);
    SDL2R_DEFINE_ENUM_VALUE(EnumWindowEventID, WINDOWEVENT_RESTORED);
    SDL2R_DEFINE_ENUM_VALUE(EnumWindowEventID, WINDOWEVENT_ENTER);
    SDL2R_DEFINE_ENUM_VALUE(EnumWindowEventID, WINDOWEVENT_LEAVE);
    SDL2R_DEFINE_ENUM_VALUE(EnumWindowEventID, WINDOWEVENT_FOCUS_GAINED);
    SDL2R_DEFINE_ENUM_VALUE(EnumWindowEventID, WINDOWEVENT_FOCUS_LOST);
    SDL2R_DEFINE_ENUM_VALUE(EnumWindowEventID, WINDOWEVENT_CLOSE);
