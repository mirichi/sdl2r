...
VALUE sdl2r_enum_HatPositions;
VALUE sdl2r_enum_ButtonState;
VALUE sdl2r_enum_EventType;
VALUE sdl2r_enum_WindowEventID;
...
//    SDL2R_DEFINE_SINGLETON_METHOD(mSDL, wait_event_timeout, 0);
    ...
    // define enum
    SDL2R_DEFINE_ENUM(HatPositions);
    SDL2R_DEFINE_ENUM_VALUE(HatPositions, HAT_CENTERED);
    SDL2R_DEFINE_ENUM_VALUE(HatPositions, HAT_UP);
    SDL2R_DEFINE_ENUM_VALUE(HatPositions, HAT_RIGHT);
    SDL2R_DEFINE_ENUM_VALUE(HatPositions, HAT_DOWN);
    SDL2R_DEFINE_ENUM_VALUE(HatPositions, HAT_LEFT);
    SDL2R_DEFINE_ENUM_VALUE(HatPositions, HAT_RIGHTUP);
    SDL2R_DEFINE_ENUM_VALUE(HatPositions, HAT_RIGHTDOWN);
    SDL2R_DEFINE_ENUM_VALUE(HatPositions, HAT_LEFTUP);
    SDL2R_DEFINE_ENUM_VALUE(HatPositions, HAT_LEFTDOWN);

    SDL2R_DEFINE_ENUM(ButtonState);
    SDL2R_DEFINE_ENUM_VALUE(ButtonState, PRESSED);
    SDL2R_DEFINE_ENUM_VALUE(ButtonState, RELEASED);

    SDL2R_DEFINE_ENUM(EventType);
    SDL2R_DEFINE_ENUM_VALUE(EventType, FIRSTEVENT);
    SDL2R_DEFINE_ENUM_VALUE(EventType, QUIT);
    SDL2R_DEFINE_ENUM_VALUE(EventType, APP_TERMINATING);
    SDL2R_DEFINE_ENUM_VALUE(EventType, APP_LOWMEMORY);
    SDL2R_DEFINE_ENUM_VALUE(EventType, APP_WILLENTERBACKGROUND);
    SDL2R_DEFINE_ENUM_VALUE(EventType, APP_DIDENTERBACKGROUND);
    SDL2R_DEFINE_ENUM_VALUE(EventType, APP_WILLENTERFOREGROUND);
    SDL2R_DEFINE_ENUM_VALUE(EventType, APP_DIDENTERFOREGROUND);
    SDL2R_DEFINE_ENUM_VALUE(EventType, WINDOWEVENT);
    SDL2R_DEFINE_ENUM_VALUE(EventType, SYSWMEVENT);
    SDL2R_DEFINE_ENUM_VALUE(EventType, KEYDOWN);
    SDL2R_DEFINE_ENUM_VALUE(EventType, KEYUP);
    SDL2R_DEFINE_ENUM_VALUE(EventType, TEXTEDITING);
    SDL2R_DEFINE_ENUM_VALUE(EventType, TEXTINPUT);
    SDL2R_DEFINE_ENUM_VALUE(EventType, MOUSEMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EventType, MOUSEBUTTONDOWN);
    SDL2R_DEFINE_ENUM_VALUE(EventType, MOUSEBUTTONUP);
    SDL2R_DEFINE_ENUM_VALUE(EventType, MOUSEWHEEL);
    SDL2R_DEFINE_ENUM_VALUE(EventType, JOYAXISMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EventType, JOYBALLMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EventType, JOYHATMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EventType, JOYBUTTONDOWN);
    SDL2R_DEFINE_ENUM_VALUE(EventType, JOYBUTTONUP);
    SDL2R_DEFINE_ENUM_VALUE(EventType, JOYDEVICEADDED);
    SDL2R_DEFINE_ENUM_VALUE(EventType, JOYDEVICEREMOVED);
    SDL2R_DEFINE_ENUM_VALUE(EventType, CONTROLLERAXISMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EventType, CONTROLLERBUTTONDOWN);
    SDL2R_DEFINE_ENUM_VALUE(EventType, CONTROLLERBUTTONUP);
    SDL2R_DEFINE_ENUM_VALUE(EventType, CONTROLLERDEVICEADDED);
    SDL2R_DEFINE_ENUM_VALUE(EventType, CONTROLLERDEVICEREMOVED);
    SDL2R_DEFINE_ENUM_VALUE(EventType, CONTROLLERDEVICEREMAPPED);
    SDL2R_DEFINE_ENUM_VALUE(EventType, FINGERDOWN);
    SDL2R_DEFINE_ENUM_VALUE(EventType, FINGERUP);
    SDL2R_DEFINE_ENUM_VALUE(EventType, FINGERMOTION);
    SDL2R_DEFINE_ENUM_VALUE(EventType, DOLLARGESTURE);
    SDL2R_DEFINE_ENUM_VALUE(EventType, DOLLARRECORD);
    SDL2R_DEFINE_ENUM_VALUE(EventType, MULTIGESTURE);
    SDL2R_DEFINE_ENUM_VALUE(EventType, CLIPBOARDUPDATE);
    SDL2R_DEFINE_ENUM_VALUE(EventType, DROPFILE);
    SDL2R_DEFINE_ENUM_VALUE(EventType, RENDER_TARGETS_RESET);
//    SDL2R_DEFINE_ENUM_VALUE(EventType, SDL_RENDER_DEVICE_RESET);
    SDL2R_DEFINE_ENUM_VALUE(EventType, USEREVENT);
    SDL2R_DEFINE_ENUM_VALUE(EventType, LASTEVENT);

    SDL2R_DEFINE_ENUM(WindowEventID);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventID, WINDOWEVENT_NONE);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventID, WINDOWEVENT_SHOWN);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventID, WINDOWEVENT_HIDDEN);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventID, WINDOWEVENT_EXPOSED);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventID, WINDOWEVENT_MOVED);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventID, WINDOWEVENT_RESIZED);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventID, WINDOWEVENT_SIZE_CHANGED);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventID, WINDOWEVENT_MINIMIZED);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventID, WINDOWEVENT_MAXIMIZED);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventID, WINDOWEVENT_RESTORED);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventID, WINDOWEVENT_ENTER);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventID, WINDOWEVENT_LEAVE);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventID, WINDOWEVENT_FOCUS_GAINED);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventID, WINDOWEVENT_FOCUS_LOST);
    SDL2R_DEFINE_ENUM_VALUE(WindowEventID, WINDOWEVENT_CLOSE);
